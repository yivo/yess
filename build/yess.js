(function() {
    var slice = [].slice, indexOf = [].indexOf || function(item) {
    ...
    (function(factory) {
        ...
        (function() {
            ...
            return _.mixin({
                privatizeSuperclass: privatizeSuperclass, copySuper: privatizeSuperclass
            });
        })();
        ...
        _.mixin({
            traverseObject: traverseObject, getProperty: getProperty
        });
        ...
        _.mixin({
            isConstructed: isConstructed, wasConstructed: isConstructed
        });
        ...
        (function() {
            var baseReopen, clone, extend, hasOwnProperty, isArray, isFunction, isObject, privatizeSuperclass, reopen, reopenArray, reopenClassMember, reopenClassMemberWith, reopenInstanceMember, reopenInstanceMemberWith, reopenObject, reopenWith;
            isFunction = _.isFunction, isObject = _.isObject, isArray = _.isArray, extend = _.extend, clone = _.clone, privatizeSuperclass = _.privatizeSuperclass;
            hasOwnProperty = {}.hasOwnProperty;
            baseReopen = function(Class, scope, allowFunctions, member, changes) {
                var args, changesExist, hasOwnPropertyFlag, idx, isArrayValue, isClassScope, isDefinedValue, isInstanceScope, isObjectValue, len, members, value;
                isClassScope = scope === 'ClassMembers';
                isInstanceScope = scope === 'InstanceMembers';
                members = isClassScope ? Class : Class.prototype;
                ...
                if ((Class.__super__ != null) && isInstanceScope && isDefinedValue) {
                    privatizeSuperclass(Class);
                    Class.__super__[member] = value;
                }
                if (isObjectValue || isArrayValue) {
                    if (isClassScope) {
                        if (member[hasOwnPropertyFlag] !== Class) {
                            member[hasOwnPropertyFlag] = Class;
                            value = clone(value);
                            members[member] = value;
                        }
                    } else if (!hasOwnProperty.call(members, member)) {
                        value = clone(value);
                        members[member] = value;
                    }
                    if (changesExist) {
            ...
            reopenInstanceMember = function() {
                var Class, changes, member;
                Class = arguments[0], member = arguments[1], changes = 3 <= arguments.length ? slice.call(arguments, 2) : [];
                return baseReopen.apply(null, [Class, 'InstanceMembers', false, member].concat(changes));
            };
            reopenInstanceMemberWith = function() {
                var Class, changes, member;
                Class = arguments[0], member = arguments[1], changes = 3 <= arguments.length ? slice.call(arguments, 2) : [];
                return baseReopen.apply(null, [Class, 'InstanceMembers', true, member].concat(changes));
            };
            reopenClassMember = function() {
                var Class, changes, member;
                Class = arguments[0], member = arguments[1], changes = 3 <= arguments.length ? slice.call(arguments, 2) : [];
                return baseReopen.apply(null, [Class, 'ClassMembers', false, member].concat(changes));
            };
            reopenClassMemberWith = function() {
                var Class, changes, member;
                Class = arguments[0], member = arguments[1], changes = 3 <= arguments.length ? slice.call(arguments, 2) : [];
                return baseReopen.apply(null, [Class, 'ClassMembers', true, member].concat(changes));
            };
            reopenObject = function(Class, member) {
                var base;
                if ((base = Class.prototype)[member] == null) {
                    base[member] = {};
                }
                return reopenInstanceMember.apply(null, arguments);
            };
            reopenArray = function(Class, member) {
                var base;
                if ((base = Class.prototype)[member] == null) {
                    base[member] = [];
                }
            ...
            Object.defineProperty(Function.prototype, 'reopen', {
                value: function() {
                    return reopen.apply(null, [this].concat(slice.call(arguments)));
                }
            });
            Object.defineProperty(Function.prototype, 'reopenWith', {
                value: function() {
                    return reopenWith.apply(null, [this].concat(slice.call(arguments)));
                }
            });
            Object.defineProperty(Function.prototype, 'reopenObject', {
                value: function() {
                    return reopenObject.apply(null, [this].concat(slice.call(arguments)));
                }
            });
            Object.defineProperty(Function.prototype, 'reopenArray', {
                value: function() {
                    return reopenArray.apply(null, [this].concat(slice.call(arguments)));
                }
            });
            return _.mixin({
                reopen: reopen,
                ...
                reopenClassMember: reopenClassMember,
                reopenClassMemberWith: reopenClassMemberWith
            });
        })();
        return _;
    });
